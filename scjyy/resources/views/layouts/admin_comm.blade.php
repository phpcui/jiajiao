...
<script>
   ...
   if (window.location.href=='http://scjj.com/admin') {

        $('#nav1').attr('class','active');
    }
    if (window.location.href=='http://scjj.com/checklist') {

        $('#nav2').attr('class','active');
    }
    if (window.location.href=='http://scjj.com/orderlist') {

        $('#nav3').attr('class','active');
    }
    if (window.location.href=='http://scjj.com/allorder') {

        $('#nav4').attr('class','active');
    }
    if (window.location.href=='http://scjj.com/alluser') {

        $('#nav5').attr('class','active');
    }
    if (window.location.href=='http://scjj.com/resorder') {

        $('#nav6').attr('class','active');
    }
    if (window.location.href=='http://scjj.com/example') {

        $('#nav7').attr('class','active');
    }
    if (window.location.href=='http://scjj.com/managecenter') {
